...
status: verifying
stopped_at: Completed 07-01 (Mock Papers 1 and 2 — J282/01 Language papers with auth gate and per-section mark scheme reveals)
last_updated: "2026-03-26T12:32:11.098Z"
...
| Phase 07-mock-papers P01 | 7 | 2 tasks | 2 files |
...
- [Phase 07-mock-papers]: Per-section mark scheme toggle (A/B/C) preferred over full-paper reveal — allows section-by-section self-marking
- [Phase 07-mock-papers]: Mock Papers live in gcse/mock-papers/ with ../../ relative paths; nav includes Mock Papers dropdown on all paper pages
- [Phase 07-mock-papers]: Paper topics chosen for variety: Paper 1 military/mythology, Paper 2 festival/building — different constructions in Section C per paper
...
Last session: 2026-03-26T12:32:11.096Z
Stopped at: Completed 07-01 (Mock Papers 1 and 2 — J282/01 Language papers with auth gate and per-section mark scheme reveals)
Resume file: None
